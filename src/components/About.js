            ...
            <div className="about-section-col">
              <div className="about">
                <p>
                  ...
                  provident ea hic, neque amet sequi temporibus iure aliquid
                  placeat inventore. Quae dolores dolore, cum nulla quas ipsum
                  facere maxime, necessitatibus!
                </p>
                <a src="/about">Read More</a>
              </div>
            </div>
            <div className="about-section-col">
